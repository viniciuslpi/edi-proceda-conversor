...
require('Registros/Intercambio.php');
require('Registros/DadosComplementares.php');
require('Registros/Documento.php');
require('Registros/TotalConhecimentosEmbarcados.php');
require('Registros/Transportadora.php');
require('Registros/ConhecimentoEmbarcado.php');
